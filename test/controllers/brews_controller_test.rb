...
class BrewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create brew" do
    assert_difference("Brew.count") do
      post brews_url, params: { brew: { dose: @brew.dose, grind: @brew.grind, rating: @brew.rating, recipe_id: @brew.recipe_id } }
    end
  ...
  test "should update brew" do
    patch brew_url(@brew), params: { brew: { dose: @brew.dose, grind: @brew.grind, rating: @brew.rating, recipe_id: @brew.recipe_id } }
